...
# 9 number of anchor & 4 number of y1, x1, y2, x2(anchor box x, y coordinates) / shape of (9, 4)


def generate_anchors(base_size=16, ratios=[0.5, 1, 2, 4],     # 1:2, 1:1, 2:1, 4:1(wide) 
                     scales=2**np.arange(3, 5)):              # 8,16,32 / np.arange(3,7)=array([3,4,5,6]), 2 ** 3 = 8 (2^3) 
    """                                                 
...
# make anchor (위에 있는 9,4 shape로 나옴)
